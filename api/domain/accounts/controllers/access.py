...
from api.db.models import User as UserModel  # noqa: TCH001
from api.domain.accounts import urls
from api.domain.accounts.dependencies import provide_roles_service, provide_users_service
from api.domain.accounts.guards import auth, requires_active_user
from api.domain.accounts.schemas import AccountLogin, AccountRegister, User
from api.domain.accounts.services import RoleService, UserService
