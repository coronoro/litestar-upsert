...
class ApplicationConfigurator(InitPluginProtocol, CLIPluginProtocol):
    ...
    def on_cli_init(self, cli: Group) -> None:
        from api.cli.commands import user_management_app
    ...
    def on_app_init(self, app_config: AppConfig) -> AppConfig:
        ...
        Args:
            app_config: The :class:`AppConfig <.config.api.AppConfig>` instance.
        """

        from advanced_alchemy.exceptions import RepositoryError
        from litestar.security.jwt import Token

        from api.config import constants, get_settings
        from api.db.models import User as UserModel
        from api.lib.exceptions import ApplicationError, exception_to_http_response
